                                        ...
                                        {/* <div className="collapse navbar-collapse" id="navbarNav"> */}
                                            <ul className="navbar-nav">
                                                <li className="nav-item">
                                                    <a onClick={handleClick} className="nav-link" aria-current="page" href="contact">Contact <p className='text-smal'>Tel : 00 00 00 00 00 <br /> Gmail : sarloisebtp@gmail.com</p></a>
                                                </li>
                                                <li className="nav-item">
                                                    <a onClick={handleClick} className="nav-link" href="our_services">Nos Services</a>
                                                </li>
                                                <li className="nav-item">
                                                    <a onClick={handleClick} className="nav-link" href="galleries">Galleries</a>
                                                </li>
                                                <li className="nav-item">
                                                    <a onClick={handleClick} className="nav-link" href="about" >A propos de nous</a>
                                                </li>
                                            </ul>
                                        {/* </div> */}
                                    </div>
